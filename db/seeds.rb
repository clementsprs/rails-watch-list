...
List.create(name: "Sport")


Bookmark.create!(comment: "blablabla", list_id: list1.id, movie_id: movie1.id )
Bookmark.create(comment: "xdfidofbjd", list_id: list1.id, movie_id: movie2.id )
